...
div.stButton>button, div.stDownloadButton>button { 
    ...
    box-shadow:10px 10px 20px #d1d9e6, -10px -10px 20px #ffffff !important; font-weight:bold !important; height:110px !important; width:100% !important; 
}
button:active,
